...
const exitBtn = document.querySelector('.exist-btn');
...
function optionSelected(answer) {
  ...
  let alloOptions = optionsList.children.length;
...
function showResultBox() {
  ...
  scoreText.textContent=`Você conseguiu ${userScore} de ${questions.length} Questões`;
  ...
  let progress = setInterval(()=>{
    ...
    circularProgress.style.background=`conic-gradient(#c43e00 ${progressStartValue * 3.6}deg,rgba(255,255,255,.1)0deg)`;
